...
- 🚀 Software Developer at **Translab Technologies**, working on **GenAI Solutions**
- ⚙️ 3+ years building **Generative AI, Agentic AI, RAG systems, and full-stack applications**
- 🏦 Delivered **8+ production-grade GenAI use cases** across BFSI, compliance, and enterprise automation, contributing to **25+ enterprise AI solutions**
- 🔐 Built a **production banking AI application** for real-time RBI compliance, processing **10,000+ regulatory queries/month**
- 🧩 Experience across the full stack: research → fine-tuning → deployment → observability
- 🌱 Currently deepening expertise in agentic workflows, LLM Gateway architecture, and inference optimization
- 📍 Based in Jammu & Kashmir / Bangalore, India
...
![OpenAI](https://img.shields.io/badge/LLMs-RAG%20%7C%20Agentic%20AI-412991?style=flat-square)
...
![GitLab CI/CD](https://img.shields.io/badge/GitLab%20CI-FC6D26?style=flat-square&logo=gitlab&logoColor=white)
